...
public class ClientHandler {
    ...
    private void authenticateUser(Server server) throws IOException {
        ...
        while (!isAuthenticated) {
           // sendMessage("Для входа в чат авторизуйтесь или зарегистрируйтесь");
            ...
            switch (command) {
                case "/auth" -> {
                    ...
                    if (username == null || username.isBlank()) {
                        sendMessage("Указан неверный логин/пароль или вы не зарегистрированы \nРегистрация выполняется командой /register login nick role password");
                    } else {
                ...
                default -> {
                    sendMessage("Требуется авторизация с помощью команды: /auth login password");
                }
            }
        }
    }
...
//                            userList.stream().collect(Collectors.joining(","));
                    ...
                    case "/help" -> {
                        sendMessage("Доступные команды чата: \n/auth login password \n/register login nick role password \n/exit \n/kick \n/role \n/list \n/w");
